...
export default function App() {
  ...
  const onExport = (kind: "alloc" | "person" | "role") => {
    ...
    if (kind === "alloc") downloadCsv(`loe_allocations${suffix}.csv`, allocationsToCsv(allocations));
    else if (kind === "person") downloadCsv(`loe_by_person${suffix}.csv`, personsToCsv(computePersonAggs(allocations)));
    else downloadCsv(`loe_by_role${suffix}.csv`, rolesToCsv(computeRoleAggs(allocations)));
  };
  ...
  if (!dataset) return <div className="app"><div className="notice">Loading latest LOE report…</div></div>;
  ...
  return (
    <div className="app">
      ...
      <div className="footer">
        ...
        {" · "}
        <a href="https://github.com/Disasters-Learning-Portal/disasters-aws-conversion" target="_blank" rel="noreferrer">
          disasters-aws-conversion
        </a>
        {" · "}Reports regenerated by the LOE GitHub Action.
      </div>
    </div>
  );
}
